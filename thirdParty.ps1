...
Start-Process -FilePath $env:TEMP\PathOfBuildingCommunity-Setup-2.30.1.exe
Start-Process -FilePath $env:TEMP\SteamSetup.exe
Start-Process -FilePath $env:TEMP\Awakened-PoE-Trade-Setup.exe
Start-Process -FilePath $env:TEMP\PoeLurkerSetup.exe
Start-Process -FilePath $env:TEMP\GeForce_Experience_v3.27.0.112.exe
Start-Process -FilePath $env:TEMP\XMouse.exe